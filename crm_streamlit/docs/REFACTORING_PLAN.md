...
- Рабочий сервер: `sergey@10.8.0.13`, каталог `/opt/CRM_Streamlit`; локальный компьютер не является средой приёмки.
...
- Сервер: `sergey@10.8.0.13`, рабочий каталог `/opt/CRM_Streamlit`.
- Ветка: `main`.
