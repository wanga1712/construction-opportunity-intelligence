...
Сервер 13 (<S13_SSH_USER> / S13). Обрабатывает документы из очереди document_processing_queue на сервере 7.
...
PostgreSQL на S7, база `tender_monitor`. Таблицы: docs/database/tables/
