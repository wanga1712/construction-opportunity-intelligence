...
SERVICE_LABELS_RU = {
    ...
    "crm-procurement-sync.service": "Синхронизация закупок",
    "crm-ai-assessment-runner.timer": "AI routing",
    "crm-ai-assessment-runner.service": "AI routing",
    "tender-docs-daemon-open.service": "Обработка документов",
    "tender-docs-daemon-awarded.service": "Обработка документов",
    "crm-v3-analytics-refresh.timer": "Аналитика V3",
    "crm-v3-analytics-refresh.service": "Аналитика V3",
    "crm-system-health-collector.service": "Мониторинг серверов",
    "crm-computer-tz-loop.service": "Компьютерный контур",
