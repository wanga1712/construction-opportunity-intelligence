...
def main():
    ...
    print("TRACES:")
    traces = c.execute_query("SELECT id, attempt_count, consensus_state, research_completeness, document_set_hash FROM crm_v3_autonomous_analysis_traces WHERE procurement_id = 900000700")
    for tr in traces:
        print(tr)
