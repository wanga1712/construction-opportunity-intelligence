...
path_it = "/opt/CRM_Streamlit_rescue/src/services/commercial_routing_v3/parsed_content_iterator.py"
code_it = '''from dataclasses import dataclass, field
import json, os, re
...
with open(path_it, "w", encoding="utf-8") as f:
    f.write(code_it)

print("DEPLOYED CLEAN parsed_content_iterator.py TO S13!")
