...
# -*- coding: utf-8 -*-
"""
Directly updates files using raw UTF-8 bytes to guarantee zero encoding mangling on Windows.
"""
import os
...
val_code = '''"""Context-based semantic validator for raw document matches.
...
with open(VAL_PATH, "wb") as f:
    f.write(val_code.encode("utf-8"))

print("Wrote context_validator.py in raw UTF-8 bytes.")
