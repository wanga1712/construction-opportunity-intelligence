#!/usr/bin/env python3
"""
Writes UTF-8 bytes directly to files using raw python byte arrays.
"""
import os
...
# Reset context_validator.py and context_validator_service.py to git HEAD
os.system(f"git checkout -- {VAL_PATH} {SVC_PATH}")
...
print("Updated context_validator_service.py")
...
print("Created test_context_validator_v4_decision_boundary.py")
