with open("tender_documents_research/document_processor/context_validator.py", "w", encoding="utf-8") as f:
    f.write('''"""Context-based semantic validator for raw document matches.
