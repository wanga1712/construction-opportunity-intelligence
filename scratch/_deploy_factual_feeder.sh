...
code = '''"""Factual Feeder V3 — Headless research pipeline feeder based on factual procurement state.
...
print("CREATED FACTUAL FEEDER V3 SERVICE ON S13 AT:", path_feeder)
