...
- Deploy key: `/home/sergey/.ssh/id_ed25519_construction_opportunity`, read-only; приватный ключ не копировался.
...
|---|---|---|---|---|---|
| `document_processor/daemon.py` | `afd65ba1379001a35ad5c88f02b521967401823b1cca6884e24d45af283cd4f8` | `bd8d47f7423743fe9e7e8d628406fd799ee7611b48bde0e1448c0eaec0b51d03` (line endings only) | `sergey/sergey/666` | `/opt/tender_documents_research/backups/stage2v_<ts>/daemon.py` | backup exact file; `install -o sergey -g sergey -m 666`; `sha256sum`; restore backup |
| `document_processor/queue_manager.py` | `d59b349dc26fdcabcb9a522f643fc88526e03a4abcc45768303255b6010fca39` | same | `sergey/sergey/666` | `.../queue_manager.py` | same procedure |
| `document_processor/task_completion.py` | `50a8dceda9d29e73c6be685fc1f57a28087201e6954252ae8e3ea8b386d52d17` | same | `sergey/sergey/666` | `.../task_completion.py` | same procedure |
| `document_processor/task_result.py` | `c1fef3aeccafe1ef8bcfa5a38ac75300ae9a01c68adf83e09aec1d1cab20b12c` | same | `sergey/sergey/666` | `.../task_result.py` | same procedure |
| `document_processor/resume_constants.py` | `198333d8555333b295e39e70732f9e77044b00c885f0b85647925ac89d394a00` | same | `sergey/sergey/666` | `.../resume_constants.py` | same procedure |
