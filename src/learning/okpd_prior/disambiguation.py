...
RE_CONSTRUCTION_KEYWORDS = re.compile(
    ...
    r"напольн\w*|полы?\b|полов\b|полами\b|полах\b|фасад\w*|шв[а-я]*|инъектирован\w*|шпунт\w*|"
    r"свай\w*|сва[иея]\b|котлован\w*|бетон\w*|асфальт\w*|дорог\w*|мост\w*|электромонтаж\w*|"
    r"светильник\w*|освещени\w*|устройств\w*|теплоснабжен\w*|водоснабжен\w*|канализац\w*|"
    r"вентиляц\w*|фасадн\w*|отделочн\w*)\b",
    re.IGNORECASE,
)
