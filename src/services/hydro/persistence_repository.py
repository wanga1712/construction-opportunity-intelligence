            ...
            with self.connection:
                with self.connection.cursor() as cur:
                    ...
                    for key, group in grouped.items():
                        ...
                        counts[lstatus] += 1
                        for obj in group:
                            cur.execute("""INSERT INTO crm_hydro_lead_objects (lead_id,parking_object_id,relation_method,relation_confidence,is_primary) VALUES (%s,%s,'SOURCE_ID',1,%s) ON CONFLICT (lead_id,parking_object_id) DO NOTHING""", (lid, object_ids[obj.identity_key], obj.identity_key == group[0].identity_key))
