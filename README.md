...
```
Сервер 7 (10.8.0.7)          Сервер 13 (10.8.0.13)
─────────────────────         ─────────────────────────────────
...
psql -h 10.8.0.7 -U postgres -d tender_monitor < database/tender_monitor_schema.sql
psql -h 10.8.0.7 -U postgres -d crm < database/crm_schema.sql
...
```bash
# Сервер 7
ssh -i ~/.ssh/id_vpn_home wanga@10.8.0.7

# Сервер 13 (через ProxyJump)
ssh -i ~/.ssh/id_vpn_home -o ProxyJump=wanga@10.8.0.7 sergey@10.8.0.13
```
