...
def main():
    ...
    try:
        with conn.cursor(cursor_factory=RealDictCursor) as cur:
            ...
            print("  SOURCE_AVAILABLE_FIELD: structured_extraction_runs.source_available")
            print("  EXTRACTION_ELIGIBLE_FIELD: structured_extraction_runs.extraction_eligible")
