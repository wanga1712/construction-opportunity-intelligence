...
class DatabaseManager:
    ...
    def __init__(self, db_configs: Optional[Dict[str, Dict[str, Optional[str]]]] = None):
        ...
        if self.db_configs is None:
            tender_cfg = {
                "host": os.getenv("DB_HOST_TENDER") or os.getenv("DB_HOST"),
                "name": os.getenv("DB_DATABASE_TENDER") or os.getenv("DB_DATABASE"),
                "user": os.getenv("DB_USER_TENDER") or os.getenv("DB_USER"),
                "password": os.getenv("DB_PASSWORD_TENDER") or os.getenv("DB_PASSWORD"),
                "port": os.getenv("DB_PORT_TENDER") or os.getenv("DB_PORT"),
            }

            catalog_cfg = {
                "host": os.getenv("DB_HOST_CATALOG") or os.getenv("PC2_DB_HOST"),
                "name": os.getenv("DB_DATABASE_CATALOG") or os.getenv("PC2_DB_DATABASE"),
                "user": os.getenv("DB_USER_CATALOG") or os.getenv("PC2_DB_USER"),
                "password": os.getenv("DB_PASSWORD_CATALOG") or os.getenv("PC2_DB_PASSWORD"),
                "port": os.getenv("DB_PORT_CATALOG") or os.getenv("PC2_DB_PORT"),
            }

            self.db_configs = {
                self.default_alias: tender_cfg,
            }

            if any(catalog_cfg.values()):
                self.db_configs["product_catalog_2"] = catalog_cfg
        ...
        self.db_host = default_cfg.get("host") or os.getenv("DB_HOST_TENDER") or os.getenv("DB_HOST")
        self.db_name = default_cfg.get("name") or os.getenv("DB_DATABASE_TENDER") or os.getenv("DB_DATABASE")
        self.db_user = default_cfg.get("user") or os.getenv("DB_USER_TENDER") or os.getenv("DB_USER")
        self.db_password = default_cfg.get("password") or os.getenv("DB_PASSWORD_TENDER") or os.getenv("DB_PASSWORD")
        self.db_port = default_cfg.get("port") or os.getenv("DB_PORT_TENDER") or os.getenv("DB_PORT")
    ...
    def _create_connection(self, alias: str, cfg: Dict[str, Optional[str]]):
        ...
        if alias == self.default_alias:
            host = cfg.get("host") or os.getenv("DB_HOST_TENDER") or os.getenv("DB_HOST")
            name = cfg.get("name") or os.getenv("DB_DATABASE_TENDER") or os.getenv("DB_DATABASE")
            user = cfg.get("user") or os.getenv("DB_USER_TENDER") or os.getenv("DB_USER")
            password = cfg.get("password") or os.getenv("DB_PASSWORD_TENDER") or os.getenv("DB_PASSWORD")
            port = cfg.get("port") or os.getenv("DB_PORT_TENDER") or os.getenv("DB_PORT")
        elif alias == "product_catalog_2":
            host = cfg.get("host") or os.getenv("DB_HOST_CATALOG") or os.getenv("PC2_DB_HOST")
            name = cfg.get("name") or os.getenv("DB_DATABASE_CATALOG") or os.getenv("PC2_DB_DATABASE") or "product_catalog_2"
            user = cfg.get("user") or os.getenv("DB_USER_CATALOG") or os.getenv("PC2_DB_USER")
            password = cfg.get("password") or os.getenv("DB_PASSWORD_CATALOG") or os.getenv("PC2_DB_PASSWORD")
            port = cfg.get("port") or os.getenv("DB_PORT_CATALOG") or os.getenv("PC2_DB_PORT")
        else:
            host = cfg.get("host")
            name = cfg.get("name")
            user = cfg.get("user")
