...
## 7. Первая группа (факт на сервере `wanga@10.0.0.7`)
...
scp document_processor/resume_constants.py document_processor/task_result.py \
    ...
    wanga@10.0.0.7:/opt/tendermonitor/

ssh wanga@10.0.0.7 "sudo systemctl restart tendermonitor-document-research.service"
```
