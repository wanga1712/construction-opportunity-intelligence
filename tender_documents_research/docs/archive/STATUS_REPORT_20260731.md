...
## Сервер 13 (sergey / 10.8.0.13) — Linux Mint
...
## Сервер 7 (wanga / 10.8.0.7) — PostgreSQL
...
- Скрипт: /home/wanga/weekly_backup.sh
...
- Проверить code sync 7→13 (/home/wanga/backup.log на сервере 7)
