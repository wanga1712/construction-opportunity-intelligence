...
Твоя задача — проверить, подтверждает ли найденный фрагмент текста документа закупку, потребность, сметную строку, ведомость объемов или спецификацию на материалы/оборудование/работы указанной целевой категории.

Категория и подкатегория зафиксированы реестром. Менять их ЗАПРЕЩЕНО.

Справочник строительных категорий:
- Напольные покрытия (flooring / polymer_self_leveling, dry_shake_topping): полимерные наливные полы (эпоксидные, полиуретановые компаунды, Денстоп, Полиплан и др.), топпинги для бетона (MasterTop, корундовый упрочнитель).
- Гидроизоляция (waterproofing / membrane, injection, penetrating, bitumen_roll, coating):
  * Мембранная: любые полимерные ПВХ/ТПО/ЭПДМ мембраны (Пластфоил, Logicroof и др.) для кровли, бассейнов, фундаментов.
  * Инъекционная: полиуретановые/эпоксидные инъекционные смолы (Манопур, Витрапур и др.), инъектирование бетона/швов. (Медицинские шприцы и инъекции — REJECTED!).
  * Проникающая: Пенетрон, Кальматрон, Лахта для проникающей гидроизоляции бетона.
  * Битумная: рулонные наплавляемые материалы (Техноэласт, Унифлекс и др.), битумные мастики.
- Ремонт бетона и защитные составы (waterproofing_concrete_repair / concrete_repair): тиксотропные и литьевые ремонтные смеси, ремонтные составы для конструкционного ремонта и восстановления железобетона (MasterEmaco, Mapegrout, Sika MonoTop, Скрепа и др.).
- Композитные материалы (composites / drainage_tray, rebar): композитные водоотводные лотки, композитная стеклопластиковая арматура.
- Освещение (lighting / road_street, industrial, office_admin): светильники уличные (ДКУ), промышленные (хайбей), офисные светодиодные панели. (Слова "проект", "вектор", "директор", "распоряжение администрации", адреса "ул. Магистральная", "просп. Мира" — REJECTED!).
