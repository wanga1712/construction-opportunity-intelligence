...
- Гидроизоляция и ремонт бетона (waterproofing_concrete_repair / concrete_repair): тиксотропные и литьевые смеси для ремонта бетона (MasterEmaco, Mapegrout, Sika MonoTop и др.).
